export default {
  ...
  Help: {
    ...
    gettingStarted: {
      ...
      howDownload:
        'Go to the "@:Navigation.online" tab, find a mod and hit download. It\'ll also download the dependencies saving you time.',
      howLaunchModded:
        'Once you\'ve installed the mods you\'d like, click on **"@:Navigation.launchModded"** in the top left',
    },
    slowGame: {
